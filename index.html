...
<html>
    ...
    <bory>
<div> 
        <br><img src="jp_topoLogotipo.png"/>
        <br>
        <U>
            <a href="#subtitulo1" href="jp_posterFilme_JurassicPark1.jpg">FILMES</a> 
            <a href="#subtitulo2">|PRÊMIOS</a>
            <a href="file:///C:/Users/jeff/OneDrive/Documentos/GitHub/aula002/formulariodelogin.html"> Formulário / Login</a>
</div>            
        </U>
        <br>
<article>
        <section>
            <div> <h1><b> FILMES DA SAGA JURASSIC PARK  </b></h1> </div>

    <div class= "g" > <div class="dino"> <p id="subtitulo1"><img src="jp_posterFilme_JurassicPark1.jpg"></p> 
        ...
        <p>É estrelado por Sam Neill, Laura Dern, Jeff Goldblum, Richard Attenborough, Ariana Richards, Joseph
                ...
                <br>
        <section>
        <div> <img src="jp_posterFilme_JurassicPark2.jpg">
        <h2><b>JURASSIC PARK: O O MUNDO PERDIDO</b></h2>
        <p>The Lost World: Jurassic Park (no Brasil, Jurassic Park 2 ­ O Mundo perdido; em Portugal, O Mundo
            ...
            Spielberg, sendo o segundo da franquia Jurassic Park.</p>
        <p>O filme foi produzido por Gerald R. Molen e Colin Wilson. O roteiro foi escrito por David Koepp, baseado
            ...
            <br>
        <section> 
        <div> <img src="jp_posterFilme_JurassicPark3.jpg">
        <h2><b>JURASSIC PARK III</b></h2>
        <p>Jurassic Park III (No Brasil, Jurassic Park 3 e em Portugal, Parque Jurássico III) é um filme estadunidense de
            ficção científica e aventura lançado originalmente em 18 de julho de 2001 nos cinemas estadunidenses.</p>
        <p>É a continuação de The Lost World: Jurassic Park, de 1997. Foi dirigido por Joe Johnston e produzido por
            ...
            o terceiro filme desta. Foi o primeiro da saga que não foi dirigido por Steven Spielberg<p><br>
    </div> 
        </section>
        <br>
        <section> 
            <div> <img src="jp_posterFilme_JurassicPark4.jpg">
        <p><h2>JURASSIC WORLD</h2></p>
        <p>Jurassic World (no Brasil Jurassic World: O Mundo dos Dinossauros; em Portugal Mundo Jurássico) é um
            filme estadunidense de ficção científica , aventura, e ação dirigido por Colin Trevorrow[5].</p>
...
<article>
    <div>    
        <section>
            <div> <h2 id="subtitulo2">PRÊMIOS</h2>
        <table border="10"> 
    </div>
    ...
    <div>
        ...
        <br>
        <section><p>JURASSIC PAGE ­ O seu canal de informações sobre Jurassic Park</p> </section>
</article>
    </bory>
</html>
